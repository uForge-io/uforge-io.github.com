...
Compare measured scenes with the product budget, then repeat the combined workload: user input, display updates, wireless traffic, audio or sensors, storage, and a complete sleep/wake cycle. Investigate every unexpected wake source and every subsystem that prevents the intended sleep state. The [Plan a Product](../../sf32-products/family/product-planning.md) page shows where this evidence belongs in the product handoff.
