...
Continue with [Design for Production](../design-for-production.md) for the full design-review path, or return to [Choose Hardware](../choose-hardware.md) if the chip, module, or board baseline has not yet been selected.
