...
2. **Prove product functions.** Follow [Tutorials](../tutorials/overview.md) to validate input/sensor handling, BLE, a simple UI, storage if needed, and the serial recovery path.
