...
For a complete carrier-board review, continue with [Design for Production](../design-for-production.md). For module-specific implementation requirements, use the matching module design guide in the adjacent **Module Design Guides** group.
