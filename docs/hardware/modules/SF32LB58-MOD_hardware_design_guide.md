...
For the underlying chip architecture (cores, graphics, memory subsystem, and peripherals in more depth), see [SF32LB58x](../chips/SF32LB58x.md) and the [SF32LB58x Hardware Design Guide](../chips/SF32LB58x_hardware_design_guide.md).
...
- [SF32LB58x Hardware Design Guide](../chips/SF32LB58x_hardware_design_guide.md)
- [SF32LB58-DevKit-LCD](../devkits/SF32LB58-DevKit-LCD.md)
